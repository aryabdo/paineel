...
generated by YAML config files at `pa_dag_confs` folder.
...
class DouDigestDagGenerator:
    ...
    YAMLS_DIR = os.getenv("PA_DAG_CONF_DIR")

    if YAMLS_DIR is None:
        raise EnvironmentError("Environment variable PA_DAG_CONF_DIR not found!")

    YAMLS_DIR_LIST = [pa_dag_confs for pa_dag_confs in YAMLS_DIR.split(":")]
    SLACK_CONN_ID = "pa_slack_notify_paineel_dagrun"
