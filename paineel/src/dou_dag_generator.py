...
class DouDigestDagGenerator:
    ...
    YAMLS_DIR = os.getenv("PAINEEL__DAG_CONF_DIR")

    if YAMLS_DIR is None:
        raise EnvironmentError("Environment variable PAINEEL__DAG_CONF_DIR not found!")

    YAMLS_DIR_LIST = [dag_confs for dag_confs in YAMLS_DIR.split(":")]
    SLACK_CONN_ID = "slack_notify_paineel_dagrun"
