...
class EmailSender(ISender):
    ...
    def __init__(self, report_config: ReportConfig) -> None:
        ...
        self.watermark = """
            <div class="footer">
                <a href="https://www.gov.br/gestao/pt-br/assuntos/gestaoeinovacao/paineel">
                    <img src="https://www.gov.br/gestao/pt-br/assuntos/gestaoeinovacao/paineel/paineel/@@govbr.institucional.banner/b27393f0-d00b-4459-8c99-f4f084eb2432/@@images/ecce877d-c42d-4ab6-ad9b-d24073ab5063.png"
                    alt="PAINEEL" width="250">
                </a>
                <small>Esta pesquisa foi realizada automaticamente pelo
                    <a href="https://github.com/aryabdo/paineel.git">&copy; PAINEEL</a>
                </small>
            </div>
        """
