...
O código-fonte está disponibilizado no [perfil do GitHub do Ministério da Gestão e da Inovação em Serviços Públicos](https://github.com/gestaogovbr/PAINEEL).
...
[https://github.com/gestaogovbr/PAINEEL](https://github.com/gestaogovbr/PAINEEL). Abra o terminal e execute os comandos abaixo:

```bash
git clone https://github.com/gestaogovbr/PAINEEL
cd PAINEEL
```
